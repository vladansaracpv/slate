...
```shell
curl -X GET http://example.com/api/point-of-sales/{id} -H 'Accept: */*'
```
...
```shell
curl -X GET http://example.com/api/point-of-sales/{id}/isActive -H 'Accept: */*'
```
...
```shell
curl -X GET http://example.com/api/point-of-sale/search -H 'Accept: */*'
```
