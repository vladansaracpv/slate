...
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|OK|[CustomersPage](#schemapartnerpage)|
...
```shell
curl -X DELETE http://example.com/api/customer/<id> -H Authorization: Bearer <token>
```
